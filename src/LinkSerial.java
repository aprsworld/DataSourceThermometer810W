...
public class LinkSerial {
	...
	protected int serialParity;

	public LinkSerial(String serialPort, int speed, int parity) {
	...
	public boolean Connect() {
		...
		/* Setup port */
		try {
			p.setSerialPortParams(serialSpeed, SerialPort.DATABITS_8, SerialPort.STOPBITS_1, serialParity);
